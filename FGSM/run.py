...
from model_CW import model_train

train_dir="/home/kevin/Desktop/FGSM/model"
...
if __name__ == '__main__':
    ...
    try:
        saver.restore(sess, "model/FGSM_model.ckpt")
    ...
    """
    #logit2 = logit.pop()
    #sess.run(logit2, feed_dict={x: sample})
